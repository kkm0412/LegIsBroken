...
### 시놉시스
당신은 절벽에서 추락했습니다. 다리를 잃었지만 살아남았습니다.

구조연락을 하기 위해서는 직접 절벽 위로 다시 올라가야 합니다.

손으로 바위를 잡고 올라가 절벽을 등반하세요.

L.E.G.S.를 이용해 다이나믹한 등반을 이어가세요.

과연 절벽 위로 올라가 구조 받을수 있을까요?
...
### 시작 방법:
시작화면에서 차량 중앙에 있는 빨간 버튼을 *중지 트리거*로 누르면 게임이 시작됩니다.
